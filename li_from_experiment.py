...
class LiFromExperimentApp(QWidget):
    def __init__(self):
        super().__init__()
    ...
    def initUI(self):
        ...
        self.addButton.clicked.connect(self.calculate_li)
    ...
    def calculate_li(self):
        try:
            ...
            result = Experiment(mass_1, mass_2, temperature_1, temperature_2, temperature_f).calculate_li()
            self.result_label.setText(f"Latent heat of fusion: {result} cal / g °C")
        except ValueError:
